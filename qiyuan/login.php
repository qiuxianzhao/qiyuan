...
<script language="javascript">
	$(function(){
    $('.loginbox0').css({'position':'absolute','left':($(window).width()-414)/2});
...
<div class="logintop">    
    ...
    <ul class="loginlist">
    <li><a href="login1.php?card=1"><img src="images/l01.png"  alt="电子监察系统"/><p>学生<br />管理系统</p></a></li>
    <li><a href="login1.php?card=2"><img src="images/l02.png"  alt="电子监察系统"/><p>教师<br />管理系统</p></a></li>
    </ul>
